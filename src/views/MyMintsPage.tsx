        ...
        <div style={{ marginBottom: 50 }}>
          ...
          <div className="row row-cols-2 mb-4">
            ...
            <div>
              ...
              <input type="number" className="form-control form-control-grey" placeholder='1.5' {...register('publicPrice')} />
            </div>
          </div>
          <div className="row mb-4">
            <div className="col-lg-8">
              ...
              <input type="text" className="form-control form-control-grey" placeholder='0x3B6Bfd8f885e33e7E75d810DC564e33c79EDFAd7' />
            </div>
          ...
          <div className="row mb-4">
            ...
            <div className="col-lg-4">
              ...
              <input type="number" className="form-control form-control-grey" placeholder='30' />
            </div>
          </div>
          <div className="row mb-4">
            <div className="col-lg-8">
          ...
          <div className="row row-cols-3 mb-4">
            <div>
              ...
              <input type="text" className="form-control form-control-grey" placeholder='http://venatici.io' />
            </div>
            <div>
              <div className="label-with-sublabel">
              ...
              <input type="text" className="form-control form-control-grey" placeholder='http://discord.gg/siviw2fasc' />
            </div>
            <div>
              <div className="label-with-sublabel">
              ...
              <input type="text" className="form-control form-control-grey" placeholder='http://twitter.com/venatici' />
            </div>
          </div>
          ...
          <button className="btn btn-black-gradient px-4">
            <div className="content">Submit Form</div>
          </button>
        </div>
      )}
